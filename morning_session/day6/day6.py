...
^ and $ ensure that the entire password matches the pattern from start to end.
...
(?=.*[@$!%*?&]) asserts that there is at least one special character from the given set.
[A-Za-z\d@$!%*?&]{8,} matches any combination of lowercase letters, uppercase letters, digits, and special characters of at least 8 characters long.
"""
